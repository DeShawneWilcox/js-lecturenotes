...
/*
-It's important to note that if you use the array constructor to create an array, and pass in a number, you are creatign an array with an initial size. However; if you pass in more thna one arguement, you create an array that holds those values.
*/

let nums = Array(1, 2, 3, 4, 5); //Javascript allows you to omit the new operator when using thr array constructor
console.log(nums);
...
// Using square brakcets is necessary when you may not be able to use dot notation to dig through an object
let testObj = {
    'Spaces Here': true,
    noSpaces: true
}
